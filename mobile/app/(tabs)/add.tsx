      ...
      <ScrollView contentContainerStyle={styles.content}>
        {mode === 'smart' ? (
          ...
          {!manualType ? <>
            ...
            <TouchableOpacity style={styles.manageRoutinesBtn} onPress={() => router.push('/routines' as any)}><Text style={styles.manageRoutinesText}>🔄 عرض وإدارة روتيناتي</Text></TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  manageRoutinesBtn: { alignSelf: 'center', borderWidth: 1, borderColor: Colors.primary, borderRadius: BorderRadius.full, paddingHorizontal: Spacing.base, paddingVertical: Spacing.sm, marginTop: Spacing.md },
